      ...
      <header className="sticky top-0 z-20 border-b border-line bg-white/85 backdrop-blur">
        <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-2.5">
            <span className="grid h-7 w-7 place-items-center rounded-lg bg-blue-600 font-display text-[13px] font-bold text-white">
              K
            </span>
            <span className="font-display text-[17px] font-semibold tracking-tight text-ink">Kriterio</span>
          </div>
          <span className="hidden text-[11px] font-medium uppercase tracking-[0.08em] text-ink-3 sm:block">
            Kavak · Supply Inspection
          </span>
        </div>
      </header>
        ...
        <section className={`${CARD} p-5 sm:p-6`}>
          ...
          <div className="mt-4 grid grid-cols-1 items-end gap-4 sm:grid-cols-[1fr_1fr_auto]">
            ...
            <button
              ...
              disabled={!anio || !km || !email || cargando}
        ...
        {marca && ref && (
          <section className={`${CARD} p-5 sm:p-6`}>
            ...
            <p className="mt-1 text-[11px] text-ink-3">
              Reliability surveys / recalls / foros — no sale de la base de Kavak
            </p>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              ...
              <div className={`${CARD} p-4`}>
                ...
                {resultado.iqi.marcaConGrado === false && (
                  <div className="mt-2 text-[11px] text-blue-700">Marca sin grado IQI: se asumió C</div>
                )}
              </div>
              ...
              <div className={`${CARD} p-4`}>
                ...
                <div className="mt-1 text-[11px] text-ink-3">
                  ...
                  {resultado.cangrejo.tasa.vecesBase != null && ` · ${resultado.cangrejo.tasa.vecesBase}×`}
                </div>
              </div>
              ...
              <div className={`${CARD} overflow-hidden`}>
                ...
                {tabProtocolo === "normal" ? (
                  <>
                    ...
                    <div className="border-b border-blue-100 bg-blue-50 px-5 py-2.5 text-xs text-blue-900">
                      ...
                      {PROTOCOLO_HIBRIDO.etapas.map((e) => (
                        <li key={e.n} className="flex gap-3.5 px-5 py-4">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mt-0.5 text-[13px] leading-relaxed text-ink-2">{e.secuencia}</div>
                            {e.link && (
                              <div className="mt-1 text-[11px] text-blue-700">{e.link}</div>
                            )}
                          </div>
                        </li>
                      ))}
