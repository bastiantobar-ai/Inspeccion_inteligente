              ...
              <div className={`${CARD} overflow-hidden`}>
                ...
                {tabProtocolo === "normal" ? (
                  <>
                    ...
                    <div className="border-b border-line bg-paper px-5 py-2.5 text-xs text-ink-2">
                      <span className="font-semibold text-ink">Aplica a: </span>
                      {protocolo.aplicaA}
                    </div>
                    ...
                    <ol className="divide-y divide-line">
                      {protocolo.etapas.map((e) => (
                        <li key={e.n}>
                          <div className="flex items-center gap-2.5 bg-ink px-5 py-2.5 text-white">
                            <span className="grid h-5 w-5 shrink-0 place-items-center rounded-full bg-white/15 font-display text-[11px] font-semibold tabular-nums">
                              {e.n}
                            </span>
                            <span className="font-display text-[13px] font-semibold">{e.etapa}</span>
                          </div>
                          <div className="px-5 py-3.5">
                            <div className="text-[13px] leading-relaxed text-ink-2">{e.secuencia}</div>
                      ...
                      {PROTOCOLO_HIBRIDO.etapas.map((e) => (
                        <li key={e.n}>
                          <div className="flex items-center gap-2.5 bg-ink px-5 py-2.5 text-white">
                            ...
                            <span className="font-display text-[13px] font-semibold">{e.grupo}</span>
                          </div>
                          <div className="px-5 py-3.5">
                            <div className="text-[13px] leading-relaxed text-ink-2">{e.secuencia}</div>
                            {e.link && (
